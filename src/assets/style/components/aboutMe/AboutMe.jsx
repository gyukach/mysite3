    ...
    return (
        <div className={`introduce-container ${isDarkMode ? 'dark' : '' }`}>
            ...
            <div className="profile-image">
                <div className="image-placreholder"></div>
            </div>
            <div className="profile-info">
                ...
                <p className="profile-description">
                    학교에서 배운 지식을 바탕으로 여러 개의 프로젝트를 진행하며 실력을 쌓고 있습니다.
        ...
        <section className="skills-section">
            ...
            <div className="skills-list">
                {skills.map(skills => (
                    <div className="skill-item" key={skills.id}>
                        <div className="skill-info">
                            <span className="skill-name">{skills.name}</span>
                            <span className="skill-percentage">{skills.level}%</span>
                        </div>
